<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="True" CodeBehind="Cafeteria.aspx.cs" Inherits="Clase2.Cafeteria" %>
    ...
    <body>
        <form id="form1">
            <div>
                <h1>Cafetería .NET</h1>
                <br />
                <h4>Lo atiende desde el 2022 nuestro alumno estrella Miguel Ruiz</h4>
